...
public class MonteCarloTreeSearch {
	...
	/**
	 * Updates the nodes played in a game. This is the backpropogation stage of the simulation.
	 * 
	 * @param  nodes An array of all nodes traversed during the game.
	 * @param  player An array with turns played by player one represented as true and turns played by player two represented as false.
	...
	/**
	 * Plays the game from a given point off the tree with a random default policy. This is the playout stage of simulation.
	 * 
	 * @param  state The starting state.
	 * @param  playerOne True if player one is to move, false otherwise.
	 * @param  p1Net The starting net score for player one.
	 * @param  terminalState The state at which simulation will cease.
	 * @return An integer representing the result for player one (-1 for a loss, 0 for a tie, and 1 for a win).
	 */
	...
	/**
	 * Runs a single simulation and updates the tree accordingly. The majority of this method constitutes the selection stage of simulation.
	 * 
	 * @param  state The starting state.
	 * @param  p1Net The starting net score for player one.
	 * @param  pastNode A node representing the current position on the tree.
	 * @param  terminalState The state at which simulation will cease.
	...
	public static void simulate(GameState state, int p1Net, MCNode pastNode, GameState terminalState, MCTree tree, DotsAndBoxes game) {
		...
		for (int i = 0; !state.equals(terminalState); i++) {
			...
			if(currentNode != null){
				...
				/* this turns a scored state to unscored, but since it just feeds into simulateDefault, it doesn't matter */
	 ...
	 * 
	 * @param  state The state from which to select an action.
	 ...
	 * 
	 * @param  random True if random moves should be made during player two's turn. False if both players should make moves from the same tree.
